...
export function fromOAIPMHRecord2HeritageObject(
  ...
  if (aggregation !== undefined) {
    ...
    const output: HeritageObject = {
      ...
      "schema:name": input.metadata["rdf:RDF"]["edm:ProvidedCHO"]["dc:title"],
      "schema:description":
      ...
      "schema:keywords":
        input.metadata["rdf:RDF"]["edm:ProvidedCHO"]["dcterms:medium"].split(
          ", "
        ), // How do we generate URIs from these literals?
